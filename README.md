...
```
> **Mac OSX/Darwin Warning:** If you're executing bats directly (`bin/bats`) you need to brew install coreutils to obtain greadlink. Darwin's readlink does not include the -f option.
